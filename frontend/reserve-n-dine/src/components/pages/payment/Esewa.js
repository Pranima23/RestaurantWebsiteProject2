...
const Esewa = (props) => {
    ...
    return ( <>
        ...
        <input value =  {currentOrderFromLocalStorage} name = "pid" type = "text" />
        <input value = "https://reservendine.netlify.app/menu"
        type = "text" name = "su" />
        <input value = "https://reservendine.netlify.app/menu"  type = "text" name = "fu" >
        </input> <input value = "Submit" type = "submit" >
        </input> 
        </form> </>
    );
};
